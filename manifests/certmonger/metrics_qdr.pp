...
class tripleo::certmonger::metrics_qdr (
  ...
  include ::certmonger
  include ::metrics_qdr::params

  $postsave_cmd_real = pick($postsave_cmd, "systemctl restart ${::metrics_qdr::params::service_name}")
  ...
  File[$service_certificate] ~> Service<| title == $::metrics_qdr::params::service_name |>
  File[$service_key] ~> Service<| title == $::metrics_qdr::params::service_name |>
}
